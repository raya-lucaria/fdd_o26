...
| d-ciclo.svg | Ciclo de vida de un proyecto de datos: cuatro etapas en fila, con dos retornos explícitos en color propio y punteado | Diagrama propio, generado por `tools/gen_diagramas.py` | Material del curso |
