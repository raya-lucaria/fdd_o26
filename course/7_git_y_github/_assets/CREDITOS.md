...
| git-flujo.svg | Ruta: `course/7_git_y_github/_assets/git-flujo.svg`. De clonar a subir tu rama: clone, rama, commits y push, con `main` aparte y el atajo de push directo marcado como incorrecto. | Diagrama original del curso, generado por `tools/gen_git.py` | 2026-09-01 | Uso docente del curso |
