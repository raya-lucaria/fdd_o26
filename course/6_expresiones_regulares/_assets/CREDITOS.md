...
Los diez SVG salen de `tools/gen_regex.py`, que es su única fuente de verdad:
...
|---|---|---|---|---|
| ilus-regex-portada.jpg | Ruta: `course/6_expresiones_regulares/_assets/ilus-regex-portada.jpg`. Portada: sala de maquinas nocturna con una cinta de celdas luminosas, un cabezal de luz que la recorre dejando apagadas las celdas ya consumidas, y tres hilos que se bifurcan y vuelven a converger. Sin glifos legibles, sin logos, sin marcas de agua. | OpenAI Image Generation (gpt-image-2); generacion original para el curso | 2026-09-01 | Uso docente del curso |
...
| rx-piezas.svg | Ruta: `course/6_expresiones_regulares/_assets/rx-piezas.svg`. Un patrón de teléfono partido en anclas y piezas, con el alcance de cada cuantificador y el texto que consume cada pieza. | Diagrama original del curso, generado por `tools/gen_regex.py` | 2026-09-01 | Uso docente del curso |
| rx-contexto.svg | Ruta: `course/6_expresiones_regulares/_assets/rx-contexto.svg`. Seis símbolos y tres columnas: qué significa cada uno suelto, dentro de corchetes y escapado. | Diagrama original del curso, generado por `tools/gen_regex.py` | 2026-09-01 | Uso docente del curso |
| rx-backtracking.svg | Ruta: `course/6_expresiones_regulares/_assets/rx-backtracking.svg`. El cuantificador goloso tomando de más, cediendo un carácter y encajando; debajo, la clase acotada que no cede. | Diagrama original del curso, generado por `tools/gen_regex.py` | 2026-09-01 | Uso docente del curso |
...
Ninguna imagen de esta unidad procede de terceros. Los diagramas se escriben
desde `tools/gen_regex.py`, con la paleta de `skins/fdd-eva.yaml`. La portada
fue generada con OpenAI Image Generation el 2026-09-01 y, como el resto de las
ilustraciones del curso, **ninguna** representa personas reales, rostros
reconocibles, personajes con derechos, logotipos ni texto legible; se usa como
ambientacion y no como fuente de informacion tecnica.
